...
public class ServiceRepository {
    ...
    public boolean saveService(Service service) {
        ...
        String query = "INSERT INTO services (id, name, description, created_at, updated_at) VALUES (?, ?, ?, ?, ?)";
    ...
    public boolean updateService(Service service) {
        String query = "UPDATE services SET name = ?, description = ?, updated_at = ? WHERE id = ?";
        try (PreparedStatement stmt = connection.prepareStatement(query)) {
    ...
    public List<Service> searchServices(String searchTerm) {
        List<Service> services = new ArrayList<>();
        String query = "SELECT * FROM services WHERE LOWER(name) LIKE ? OR LOWER(description) LIKE ?";
